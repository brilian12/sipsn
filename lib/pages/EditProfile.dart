...
class EditProfile extends StatefulWidget {
  ...
  EditProfile({required this.id,required this.name,required this.notelp,required this.alamat, required this.email});
...
Future update() async {
    ...
    var response = await myHttp.post(
        Uri.parse('https://cleanearth.sintrenayu.com/api/edit/profile-petugas'),
        headers: headers,
